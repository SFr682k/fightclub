...
Phase::Phase(QTime d, QTime o, QString n, bool rpper, bool opper, bool rvper,
             bool a, bool c, bool oc, bool r) {
    duration = d;
    overtime = o;
    name = n;
    repperform = rpper;
...
bool Phase::getRepPerform()  { return repperform; }
bool Phase::getOppPerform()  { return oppperform; }
bool Phase::getRevPerform()  { return revperform; }
